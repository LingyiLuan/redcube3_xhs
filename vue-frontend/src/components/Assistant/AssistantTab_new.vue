  ...
  <div class="assistant-tab">
    <template v-if="!isAuthenticated">
      <div class="assistant-auth-gate">
        <Sparkles :size="48" class="auth-icon" />
        <h4>Sign in to use AI Assistant</h4>
        <p>Get personalized interview prep insights and workflow automation</p>
        <button @click="openLoginModal" class="login-btn">Sign In</button>
      </div>
    </template>
    <template v-else>
      <div class="assistant-layout">
        ...
        <div class="assistant-header">
          ...
          <div class="header-actions">
            <button @click="toggleHistoryModal" class="history-btn" :title="`History (${chats.length})`">
              <FileText :size="16" />
